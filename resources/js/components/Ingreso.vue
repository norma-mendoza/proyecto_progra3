            ...
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-header">
                        ...
                        <!-- <button plain type="button" @click="mostrarDetalle()" class="btn btn-primary">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 col-12">
                                <div class="input-group">
                                    <!-- <select class="form-control col-md-6 mr-2" v-model="criterio">
                                   ...
                                   <el-input @keyup.native.enter="
                                        listarIngreso(1, buscar, criterio)
                            ...
                            <table class="table table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                    <tr v-for="ingreso in arrayIngreso" :key="ingreso.id">
                                        <td>
                                            <button type="button" @click="verIngreso(ingreso.id)" class="btn btn-primary btn-sm">
                                            <i class="icon-eye"></i>
                                            </button> &nbsp;
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="form-inline">
                                        ...
                                        <button @click="abrirModal()" class="btn btn-primary" ><i class="fa fa-search"></i> Buscar</button>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12 ml-2">
                                <div class="row">
                                    <!-- <select class="form-control col-md-6 mr-2 " v-model="criterioA">
                                    ...
                                    <div class="mr-1  ">
                                    <template>
                                    <el-select v-model="criterioA" placeholder="Select">
                                        <el-option
                                ...
                                <div class=" mr-2">
                                    ...
                                    " placeholder="Texto a buscar" v-model="buscarA"></el-input>
                                </div>
                                <div class="">
...
import swal from 'sweetalert';
    export default {
        ...
        {
          value: 'usoTerapeutico',
          label: 'Uso terapeutico'
        },
        {
          value: 'codigo',
          label: 'Codigo'
        ...
        methods : {
            guardar() {
        this.$message({
          message: 'Compra Guardado con éxito.',
          type: 'success'
        })
        },
            ...
            desactivarIngreso(id){
               swal({
                    ...
                    if (willDelete) {
                         let me = this;
                        axios.put('/ingreso/desactivar',{'id': id}).then(function (response) {
                        me.listarIngreso(1,'','num_comprobante');
                        ...
                        swal("El ingreso ha sido anulado con éxito.", {
                        icon: "success",
                        });
                    } else {
                        swal("El ingreso no ha sido anulado!");
