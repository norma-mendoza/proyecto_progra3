                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="form-inline">
                                        <input type="text" class="form-control" v-model= "Ingrese código de articulo" @keyup.enter="buscarArticulo()" placeholder="Ingrese artículo">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                <!-- <el-button @click="registrarVenta()" type="success" :loading="true">Loading</el-button> -->
                            </div>
                        </div>
                    </div>
                    </template>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <div class="input-group">
                                        <!-- <select class="form-control col-md-4 mr-2" v-model="criterioA">
...
<script>
    ...
    export default {
        ...
        methods : {
             guardar() {
                this.$message({
                message: 'Venta Guardado con éxito.',
                type: 'success'
                })
        },
            ...
            desactivarVenta(id){
               swal({
                    ...
                    if (willDelete) {
                         let me = this;
                        axios.put('/venta/desactivar',{'id': id}).then(function (response) {
                        me.listarVenta(1,'','num_comprobante');
                        ...
                        swal("La venta ha sido anulado con éxito.", {
                        icon: "success",
                        });
                    } else {
                        swal("La venta no ha sido anulado!");
